...
export interface Cell {
  ...
  hasGlitter: boolean;
  isVisited: boolean;
  isSafe: boolean; // Indicates if the agent believes this cell is safe
  isDangerous: boolean; // Indicates if the agent believes this cell is dangerous
  isBlocked: boolean; // Currently unused, but could be for complex terrain
}
...
export interface KnowledgeBase {
  ...
  // Added for Wumpus World AI logic
  ...
  getWumpusProbability(position: Position): number; // Added this method
}
